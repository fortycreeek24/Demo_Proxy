INSERT INTO ratings (id, USER_NAME, rating) VALUES (uuid(), 'Tom', 3);
INSERT INTO ratings (id, USER_NAME, rating) VALUES (uuid(), 'Gray', 1);
INSERT INTO ratings (id, USER_NAME, rating) VALUES (uuid(), 'Sara', 5);

INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'X-Wing', "The X-wing is a versatile Rebel Alliance starfighter that balances speed with firepower. 
...
INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'B-wing', "The ship is designed around the primary airfoil, which includes a cylindrical cockpit on one end and a heavy weapons armament of proton torpedoes on the opposite end. 
...
INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'E-wing', "The E-Wing is slightly shorter than the X-Wing, and its cockpit is located just in front of the center of the fighter. 
...
INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'Hornet Interceptor', "It was designed to emulate the TIE/LN starfighter: fast, lightweight, and easily mass-produced with low-cost standard parts.
...
INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'Imperial-class Star Destroyers', "The Imperial I-class Star Destroyer, also referred to as an Imperial-class Star Destroyer or Star Destroyer, was a model of Imperial-class Star Destroyer in the service of the Imperial Navy. 
...
INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'A280 blaster rifle', "These powerful blaster rifles, known for their impressive power and capable of piercing armor, were used by planetary forces across the galaxy.
...
INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'EL-16HFE blaster rifle', "Steady, sturdy, and built for medium to long-range combat distances, the EL-16HFE was the preferred blaster rifle among fighters with the Resistance. 
The EL-16HFE blaster rifle was a blaster rifle manufactured by BlasTech Industries.");

INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'A-300 blaster rifle', "The A-300 blaster rifle was a blaster rifle manufactured by BlasTech Industries, similar in appearance to the A280 blaster rifle and almost identical to the A280-CFE.
 It was notably used by many Alliance Special Forces members of Rogue One during the Battle of Scarif.");

INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'ARC caster', "The ARC caster was a modified E-11 blaster rifle that was utilized by some types of dark troopers in the Galactic Empire. 
...
INSERT INTO information (id, PRODUCT_NAME, info) VALUES (uuid(), 'HB-9', "The HB-9 was a blaster rifle manufactured by Zenoti Arms during the Clone Wars. 
